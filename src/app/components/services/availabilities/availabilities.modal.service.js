(function () {
  ...
  /** @ngInject */
  function availabilitiesModalService($rootScope, ModalService,
    availabilitiesService, eventsService) {
    var api = {};
    ...
    function showAvailabilities() {
      availabilitiesService.getUserAvailabilities($rootScope.user.id)
        .then(function (availabilities) {
          eventsService.getUserEvents($rootScope.user.id)
      ...
      function AvailabilitiesModalController($scope, $state, myModalService,
        close, availabilities, events) {
        /* Open */
